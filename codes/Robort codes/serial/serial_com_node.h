...
#include "io/io.h"
//#include "/home/ubuntu/RM2019/src/common/rrts.h"
...
#include "rm_msgs/PositionUWB.h"
#include "rm_msgs/EnemyPos.h"
#include "serial/infantry_info.h"
#include "serial/proto/serial_com_config.pb.h"

#include <rm_msgs/ShootCtrl.h>
#include <rm_msgs/GimbalCtrl.h>
#include <rm_msgs/GameInfo.h>
#include <rm_msgs/HurtData.h>
#include <rm_msgs/ShootData.h>
#include <rm_msgs/RFID.h>
...
class SerialComNode : public rrts::common::RRTS {
 ...
 private:
   ...
   */
  void GimbalControlCallback(const rm_msgs::GimbalCtrl &msg);
  ...
  void ChassisControlCallback(const geometry_msgs::Twist::ConstPtr &vel);
   ...
   void ShootControlCallback(const rm_msgs::ShootCtrl &msg);
  ...
  ros::Subscriber sub_cmd_vel_, sub_cmd_gim_,sub_cmd_shoot_,sub_laser_scan_;
  ros::Publisher odom_pub_, gim_pub_, uwb_pose_pub_,game_info_pub_,hurt_data_pub_,shoot_data_pub_,rfid_data_pub_;
  rm_msgs::GimbalAngle gim_angle_;
  ...
  double x0,y0;
  //LYH
  rm_msgs::PositionUWB uwb_position_;
  
  
  rm_msgs::GameInfo game_info;
  rm_msgs::HurtData hurt_data;
  rm_msgs::ShootData shoot_data;
  rm_msgs::RFID rfid_data;
