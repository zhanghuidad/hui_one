...
int main(int argc, char **argv) {
 ...
 // clien.sendGoal(goal_list[num]);
  ...
  while(ros::ok())
  {
    ...
    if(client.getState()==actionlib::SimpleClientGoalState::SUCCEEDED&&counter>30)
    {
      num++;
      counter = 0;
    }
